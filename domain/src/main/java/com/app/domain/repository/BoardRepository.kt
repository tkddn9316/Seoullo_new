...
interface BoardRepository {
    ...
    suspend fun addComment(postId: String, user: User, text: String): Flow<Unit>
    suspend fun deleteComment(postId: String, commentId: String): Flow<Unit>
    suspend fun addReply(postId: String, commentId: String, user: User, text: String): Flow<Unit>
...
//    suspend fun incrementLike(postId: String, delta: Int)
    ...
    suspend fun like(postId: String, user: User): Flow<Unit>
    suspend fun unlike(postId: String, user: User): Flow<Unit>
}