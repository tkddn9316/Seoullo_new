...
-keep class com.app.domain.model.common.** { *; }
-keep class com.app.domain.model.Direction.** { *; }
-keep class com.app.domain.repository.** { *; }
-keep class com.app.domain.usecase.** { *; }
-keep class com.app.domain.util.** { *; }
